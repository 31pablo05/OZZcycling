...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { name: "Galería", path: "/galeria", icon: "📸" },
  ...
  // Verificar si alguna herramienta está activa
  const isToolsActive = () => {
    return appTools.some(tool => isActiveLink(tool.path));
  };

  // Clases de navegación según el scroll
  const navClasses = scrolled 
    ? "bg-blue-900/60 backdrop-blur-2xl border-b border-blue-200/30 shadow-2xl shadow-blue-500/10" 
    : "bg-gradient-to-r from-blue-900/80 via-blue-700/60 to-blue-500/40 backdrop-blur-xl";

  return (
    <nav className={`${navClasses} transition-all duration-700 fixed top-0 left-0 right-0 z-50 py-4 px-6`}>
      <div className="container mx-auto flex justify-between items-center">
        ...
        >
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-r from-blue-600/30 to-cyan-600/30 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-all duration-500 scale-150"></div>
            <div className="relative bg-gradient-to-br from-white/20 to-white/5 rounded-2xl p-3 border border-white/30 backdrop-blur-sm shadow-xl">
              <img
                src="/LOGO/logo2.webp"
                alt="OZZcycling Logo"
                className="h-12 w-auto drop-shadow-2xl transition-all duration-500 group-hover:brightness-110"
                width="89"
                height="48"
                loading="eager"
              />
        ...
        <div className="md:hidden">
          <button
            ...
            className="relative w-12 h-12 rounded-2xl bg-gradient-to-br from-white/20 to-white/5 backdrop-blur-xl border border-white/30 hover:from-blue-500/20 hover:to-cyan-500/20 focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all duration-500 shadow-lg hover:shadow-xl"
        ...
        <ul className="hidden md:flex items-center space-x-2">
              ...
              <Link
                ...
                className={`
                  ...
                  ${isActiveLink(item.path) 
                    ...
                    : `${scrolled ? 'text-blue-900' : 'text-white'} hover:bg-gradient-to-r hover:from-blue-500 hover:via-cyan-400 hover:to-blue-600 hover:text-white hover:scale-105`
                  }
                `}
              >
                {/* Fondo animado */}
          ...
          <li className="relative">
            ...
            >
              ...
              {/* Badge app disponible */}
              <div className="absolute -top-1 -right-1">
                <div className="flex items-center justify-center w-6 h-6 bg-blue-500 text-white rounded-full text-xs font-bold animate-pulse shadow-lg">
                  📱
                </div>
              </div>
            ...
            >
              <div className="p-4">
                <div className="text-xs font-bold text-slate-700 mb-3 flex items-center gap-2 bg-blue-50/80 px-3 py-2 rounded-lg">
                  <span>⚡</span>
                ...
                <div className="space-y-2">
                  {appTools.map((tool, idx) => (
                    <Link
                      ...
                      className={`
                        block p-3 rounded-xl transition-all duration-300 group hover:bg-gradient-to-r hover:from-blue-50 hover:to-cyan-50
                        ${tool.special 
                          ? 'bg-gradient-to-r from-green-100 to-blue-100 border-2 border-green-300 shadow-lg ring-2 ring-green-200' 
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className={`text-2xl group-hover:scale-110 transition-transform duration-300 ${tool.special ? 'animate-bounce' : ''}`}>
                          {tool.icon}
                        </div>
                        ...
                        <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                          <svg className={`w-4 h-4 ${tool.special ? 'text-green-500' : 'text-blue-500'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className={`md:hidden transition-all duration-700 ease-out overflow-hidden ${
        ...
        <div className="bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-2xl border border-white/20 mt-6 rounded-3xl mx-4 shadow-2xl shadow-blue-500/10 max-h-[80vh] overflow-y-auto mobile-menu-scroll">
          <ul className="py-6 space-y-3">
                ...
                <Link
                  ...
                  className={`
                    ...
                    ${isActiveLink(item.path) 
                      ...
                      : 'text-blue-900 hover:bg-gradient-to-r hover:from-blue-500 hover:via-cyan-400 hover:to-blue-600 hover:text-white'
                    }
                  `}
                >
                  {/* Fondo animado */}
            ...
            {/* Sección de Herramientas móvil */}
            <li className="px-4 mt-6">
              <div className="bg-gradient-to-r from-blue-500/10 to-cyan-500/10 rounded-2xl p-4 border border-blue-200/30">
                ...
                >
                  <div className="text-xs font-bold text-slate-800 flex items-center justify-center gap-2 group-hover:text-slate-900 transition-colors duration-300 bg-white/60 px-3 py-2 rounded-lg">
                    <span>🛠️</span>
                      ...
                      >
                        ...
                        <div className="flex-1">
                          ...
                          <div className={`text-xs ${
                            tool.special || isActiveLink(tool.path) ? 'text-white/80' : 'text-blue-600/80'
                          }`}>
                            {tool.description}
                          </div>
                        </div>
                ...
                {!mobileToolsOpen && (
                  <div className="text-center text-xs text-blue-600/70 mt-2">
